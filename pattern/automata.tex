...
\begin{algorithm}{NFA}
\reflisting{nfa}
\characteristics{The primary use of the NFA in its current state is for RegExp matching.}
\end{algorithm}

\begin{algorithm}{DFA}
\reflisting{dfa}
\characteristics{A DFA class implementation. Biggest feature is the possibility to create a DFA from an NFA, which provides for faster matching for automata that will run several times.\\
\\
