...
\reflisting{NWERC Template}
\reflisting{Template}
\usage{}
Standard problem template. For the NWERC02 edition of KACTL there is an NWERC Template for the weird NWERC02 rules. Problems are classified as either of:
  \begin{description}
...
\code{NWERC Template}{NWERC_Template}
