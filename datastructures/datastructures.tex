...
\deps{{\tt utility} or {\tt algorithm}}
\usage{{\tt make\_pair}, {\tt p.first}, {\tt p.second}, {\tt <}, {\tt ==}.}
\end{algorithm}
...
\deps{{\tt vector}}
\usage{{\tt resize}, {\tt push\_back}, {\tt []}.}
\books{\bookJosuttis{148}}
\end{algorithm}

\begin{algorithm}{deque}
\deps{{\tt deque}}
\usage{{\tt push\_front}, {\tt push\_back}, {\tt []}.}
\books{\bookJosuttis{160}}
\end{algorithm}

\begin{algorithm}{set}
\deps{{\tt set}}
\usage{{\tt insert}, {\tt erase}, {\tt count}.}
\books{\bookJosuttis{175}}
\end{algorithm}

\begin{algorithm}{map}
\deps{{\tt map}}
\usage{{\tt []}, {\tt count}.}
\books{\bookJosuttis{194}}
\end{algorithm}

\begin{algorithm}{list}
\deps{{\tt list}}
\usage{{\tt push\_front}, {\tt push\_back}, {\tt splice}, {\tt merge}, {\tt sort}.}
\books{\bookJosuttis{166}}
\end{algorithm}

\begin{algorithm}{queue}
\deps{{\tt queue}}
\usage{{\tt push}, {\tt empty}, {\tt front}, {\tt pop}.}
\end{algorithm}

\begin{algorithm}{priority queue}
\note{The {\tt front()} is the element with the {\em highest} key.}
\deps{{\tt queue}}
\usage{{\tt push}, {\tt empty}, {\tt front}, {\tt pop}.}
\end{algorithm}
...
\deps{{\tt stack}}
\usage{{\tt push}, {\tt empty}, {\tt top}, {\tt pop}.}
\end{algorithm}

\begin{algorithm}{heap}
\deps{{\tt algorithm}}
\usage{{\tt make\_heap}, {\tt push\_heap}, {\tt pop\_heap}, {\tt sort\_heap}.}
\end{algorithm}
